...
// 블렌드
// 다렉은 어떤 픽셀에 다른 픽셀이 덮어져서 그려질때 공식에 의해서 최종 색깔을 결정한다.
// 이 공식을 변경하거나 원하는대로 바꾸는 것을 블랜드라고 합니다.
// 
// alpha값에 대한 오해
// 
// 0이면 렌더가 안 된다 (X)
...
// 한가지 셋팅을 다수의 RenderTargetView에 적용할 수 있다.
...
// 
// 위와 같이 셋팅하면
// 텍스처 중에 알파값이 0인 부분은 소스컬러는 투명하게 즉, DestColor의 알파값은 1이 된다.
